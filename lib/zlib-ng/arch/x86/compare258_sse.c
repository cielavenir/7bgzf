...
static inline __attribute__((target("sse4.2"))) uint32_t compare256_unaligned_sse4_static(const unsigned char *src0, const unsigned char *src1) {
    uint32_t len = 0;
...
static inline __attribute__((target("sse4.2"))) uint32_t compare258_unaligned_sse4_static(const unsigned char *src0, const unsigned char *src1) {
...
Z_INTERNAL __attribute__((target("sse4.2"))) uint32_t compare258_unaligned_sse4(const unsigned char *src0, const unsigned char *src1) {
