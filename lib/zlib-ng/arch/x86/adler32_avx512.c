...
#include "../../zbuild.h"
#ifdef X86_AVX512
#define __TARGET__ __attribute__((target("avx512f,avx512dq,avx512vl,avx512bw")))
#include "../../adler32_p.h"
...
static inline __TARGET__ uint32_t adler32_fold_copy_impl(uint32_t adler, uint8_t *dst, const uint8_t *src, size_t len, const int COPY) {
