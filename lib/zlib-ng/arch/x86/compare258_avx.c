...
static inline __attribute__((target("avx2"))) uint32_t compare256_unaligned_avx2_static(const unsigned char *src0, const unsigned char *src1) {
    uint32_t len = 0;
...
static inline __attribute__((target("avx2"))) uint32_t compare258_unaligned_avx2_static(const unsigned char *src0, const unsigned char *src1) {
...
Z_INTERNAL __attribute__((target("avx2"))) uint32_t compare258_unaligned_avx2(const unsigned char *src0, const unsigned char *src1) {
