...
static inline __attribute__((target("avx2"))) void slide_hash_chain(Pos *table, uint32_t entries, const __m256i wsize) {
    table += entries;
    table -= 16;
...
Z_INTERNAL __attribute__((target("avx2"))) void slide_hash_avx2(deflate_state *s) {
