...
#if defined(__linux__) && (defined(__aarch64__) || defined(__arm__))
/// && defined(ARM_AUXV_HAS_CRC32)
///#  ifdef HWCAP_CRC32
///    return (getauxval(AT_HWCAP) & HWCAP_CRC32) != 0 ? 1 : 0;
///#  else
///    return (getauxval(AT_HWCAP2) & HWCAP2_CRC32) != 0 ? 1 : 0;
///#  endif
    return (get_arm_cpu_features() & ARM_CPU_FEATURE_CRC32) != 0 ? 1 : 0;
#elif defined(__FreeBSD__) && defined(__aarch64__)
...
#if defined(__linux__) && (defined(__aarch64__) || defined(__arm__))
/// && defined(ARM_AUXV_HAS_NEON)
///#  ifdef HWCAP_ARM_NEON
///    return (getauxval(AT_HWCAP) & HWCAP_ARM_NEON) != 0 ? 1 : 0;
///#  else
///    return (getauxval(AT_HWCAP) & HWCAP_NEON) != 0 ? 1 : 0;
///#  endif
    return (get_arm_cpu_features() & ARM_CPU_FEATURE_NEON) != 0 ? 1 : 0;
#elif defined(__APPLE__)
    int hasneon;
