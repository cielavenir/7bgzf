...
//#define WITH_GZFILEOP
		...
		#define X86_AVX2
		// https://github.com/gcc-mirror/gcc/tree/releases/gcc-5/gcc/config/i386
		// https://github.com/llvm/llvm-project/tree/release/4.x/clang/lib/Headers
		#if (defined(__GNUC__) && __GNUC__ >= 5) || (defined(__clang_major__) && __clang_major__ >= 4)
		#define X86_AVX512
		#endif
		#if (defined(__GNUC__) && __GNUC__ >= 8) || (defined(__clang_major__) && __clang_major__ >= 6)
	...
	#define ARM_FEATURES
	#define ARM_NEON
	// https://github.com/gcc-mirror/gcc/commit/5d357f260ce3312db63b4fb69bec250fa07de553
	// https://github.com/llvm/llvm-project/commit/a44c4d7173937163c90f6cb7d67401882547e8e3
	#if (defined(__GNUC__) && __GNUC__ >= 5) || (defined(__clang_major__) && __clang_major__ >= 4) // actually clang 3.5
		#define ARM_ACLE
	#endif
	#if (defined(__GNUC__) && __GNUC__ >= 14) || (defined(__clang_major__) && __clang_major__ >= 7)
