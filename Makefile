...
SOURCES		+= applet applet_stl applet/hash lib lib/cryptonite lib/libmshlsplash lib/zlib lib/zopfli lib/libdeflate lib/miniz lib/lz4 lib/zstd lib/libbzip2 lib/popt .
INCLUDES	+= 
DATA		+= data 
