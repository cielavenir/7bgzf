...
# CC=i686-w64-mingw32-gcc LIBS="-lole32 -loleaut32 -pthread" CFLAGS="-mmmx -msse -msse2" arch=noarch host_cpu=base_aliases ZLIBNG_X86=1
# CC=x86_64-w64-mingw32-gcc LIBS="-lole32 -loleaut32 -pthread" CFLAGS="-march=core2 -mfpmath=sse -mmmx -msse -msse2 -msse3 -mno-ssse3" arch=mingw host_cpu=x86_64 ZLIBNG_X86=1
